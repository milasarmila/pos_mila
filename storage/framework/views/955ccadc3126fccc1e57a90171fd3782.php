    ...
    <div class="text-center text-md-start border-bottom pb-3 mb-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted mb-0 fw-medium">
                <i class="bi bi-calendar3 me-1 text-primary"></i> <?php echo e($tanggalHariIni->translatedFormat('l, d F Y')); ?>
                ...
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-premium card-sales-total">
                        <div class="card-body p-4">
                            ...
                            <h3 class="fw-extrabold text-success mb-0 fs-2">Rp <?php echo e(number_format($ringkasan['total_penjualan'], 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-premium card-sales-count">
                        <div class="card-body p-4">
                            ...
                            <h3 class="fw-extrabold text-primary mb-0 fs-2"><?php echo e(number_format($ringkasan['total_transaksi'])); ?> <small class="text-muted fs-6 fw-normal">Struk</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-premium card-pay-cash">
                        <div class="card-body p-4">
                            ...
                            <h3 class="fw-bold text-dark mb-0">Rp <?php echo e(number_format($ringkasan['total_cash'], 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card h-100 border-0 shadow-premium card-pay-non-cash">
                        <div class="card-body p-4">
                            ...
                            <h3 class="fw-bold text-dark mb-0">Rp <?php echo e(number_format($ringkasan['total_non_tunai'], 0, ',', '.')); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover align-middle mb-0 text-sm">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $produkStokRendah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="ps-3 fw-bold text-muted"><?php echo e($produkStokRendah->firstItem() + $index); ?></td>
                                            <td class="fw-semibold text-dark"><?php echo e($produk->nama); ?></td>
                                            <td class="text-end pe-3 fw-bold text-warning fs-6"><?php echo e($produk->stok); ?></td>
                                        </tr>
                            ...
                            <table class="table table-hover align-middle mb-0 text-sm">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $produkStokHabis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="ps-3 fw-bold text-muted"><?php echo e($produkStokHabis->firstItem() + $index); ?></td>
                                            <td class="fw-semibold text-dark"><?php echo e($produk->nama); ?></td>
                                            <td class="text-end pe-3 fw-bold text-danger fs-6"><?php echo e($produk->stok); ?></td>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_mila\resources\views/dashboard.blade.php ENDPATH**/ ?>