    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-2">
                ...
                <li class="nav-item">
                    <a
                        class="nav-link px-3 rounded-2 {{ Request::is('dashboard') ? 'active bg-white text-dark fw-bold' : 'text-white custom-nav-item' }}"
                ...
                @if(auth()->check() && auth()->user()->role && strtolower(auth()->user()->role->name) === 'admin')
                    <li class="nav-item">
                        <a
                            class="nav-link px-3 rounded-2 {{ Request::is('admin/users*') ? 'active bg-white text-dark fw-bold' : 'text-white custom-nav-item' }}"
                ...
                <li class="nav-item">
                    <a
                        class="nav-link px-3 rounded-2 {{ Request::is('produk*') ? 'active bg-white text-dark fw-bold' : 'text-white custom-nav-item' }}"
                ...
                <li class="nav-item">
                    <a
                        class="nav-link px-3 rounded-2 {{ Request::is('Jenis*') ? 'active bg-white text-dark fw-bold' : 'text-white custom-nav-item' }}"
                ...
                <li class="nav-item">
                    <a
                        class="nav-link px-3 rounded-2 {{ Request::is('penjualan*') ? 'active bg-white text-dark fw-bold' : 'text-white custom-nav-item' }}"
